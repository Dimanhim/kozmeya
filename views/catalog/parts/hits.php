...
<? if($best):?>
    <div class="container hits__obj">
        <div class="tag-elem">самые популярные решения</div>
        <h3 class="h-3">
            Хиты продаж
        </h3>
        ...
        <a href="/<?=\Yii::$app->params['allPages'][\Yii::$app->params['catalogPageId']]->alias;?>" class="red__btn red__btn-arrow pos-t-r">смотреть все</a>
    </div>
<? endif;?>