 ...
 */
class SizesgroupsController extends \app\modules\admin\components\AdminController
{

    public $className = "app\models\\SizesGroups";
    public $status = "active";

    public function init(){
        $this->view->title = "Группы размеров";
