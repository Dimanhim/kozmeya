...
class VarsshowtypesvaluesController extends \app\modules\admin\components\AdminController
{
    public $className = "app\models\\VarsShowtypesValues";
    public $status = "active";

    public function init(){
        $this->view->title = "Значения для типво модификаций";
