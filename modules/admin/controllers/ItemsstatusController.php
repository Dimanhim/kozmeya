 ...
 */
class ItemsstatusController extends \app\modules\admin\components\AdminController
{

    public $className = "app\models\\ItemsStatus";
    public $status = "active";

    public function init(){
        $this->view->title = "Статусы товаров";
