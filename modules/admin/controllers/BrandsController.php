 ...
 */
class BrandsController extends \app\modules\admin\components\AdminController
{

    public $className = "app\models\\Brands";
    public $status = "active";

    public function init(){
        $this->view->title = "Коллекции";
    ...
    public function actionExport(){
        Yii::$app->functions->simpleExport(Brands::find()->all());
        exit();
    }
}
