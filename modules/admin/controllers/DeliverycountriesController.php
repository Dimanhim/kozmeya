 ...
 */
class DeliverycountriesController extends \app\modules\admin\components\AdminController
{

    public $className = "app\models\\Deliverycountries";
    public $status = "active";

    public function init(){
        $this->view->title = "Страны";
