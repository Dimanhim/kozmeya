 ...
 */
class ReviewsController extends \app\modules\admin\components\AdminController
{

    public $className = "app\models\\Reviews";
    ...
    public function actionExport(){
        Yii::$app->functions->simpleExport(Reviews::find()->all());
        exit();
    }
}
