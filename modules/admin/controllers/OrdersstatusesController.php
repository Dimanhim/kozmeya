 ...
 */
class OrdersstatusesController extends \app\modules\admin\components\AdminController
{

    public $className = "app\models\\OrdersStatuses";
    public $status = "active";

    public function init(){
        $this->view->title = "Статусы заказов";
