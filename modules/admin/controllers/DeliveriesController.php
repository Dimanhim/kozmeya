...
use app\models\DeliveriesPrices;
use Yii;
 ...
 */
class DeliveriesController extends \app\modules\admin\components\AdminController
{

    public $className = "app\models\\Deliveries";
    public $status = "active";

    public function init(){
        $this->view->title = "Типы доставки";
