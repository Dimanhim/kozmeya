 ...
 */
class ItemsreviewsController extends \app\modules\admin\components\AdminController
{

    public $className = "app\models\\ItemsReviews";
    public $status = "active";

    public function init(){
        $this->view->title = "Отзывы о товарах";
