 ...
 */
class MetatemplatesController extends \app\modules\admin\components\AdminController
{

    public $className = "app\models\\MetaTemplates";
    public $status = "active";

    public function init(){
        $this->view->title = "Шаблоны меты";
