 ...
 */
class VacanciescategoriesController extends \app\modules\admin\components\AdminController
{

    public $className = "app\models\\VacanciesCategories";
    public $status = "active";

    public function init(){
        $this->view->title = "Категории вакансий";
