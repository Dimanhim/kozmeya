...
/**
 * SliderController implements the CRUD actions for Categories model.
 */
class SliderController extends \app\modules\admin\components\AdminController
{

    public $className = "app\models\\Slider";
    public $status = "active";

    public function init(){
        $this->view->title = "Слайдер";
